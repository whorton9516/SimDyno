...
public static class ForzaFormatter
{
    ...
    public static float NormalizedSuspensionTravelFL(this byte[] bytes) => GetSingle(bytes, 68) * 100;
    public static float NormalizedSuspensionTravelFR(this byte[] bytes) => GetSingle(bytes, 72) * 100;
    public static float NormalizedSuspensionTravelRL(this byte[] bytes) => GetSingle(bytes, 76) * 100;
    public static float NormalizedSuspensionTravelRR(this byte[] bytes) => GetSingle(bytes, 80) * 100;
    ...
    public static float SuspensionTravelMetersFL(this byte[] bytes) => GetSingle(bytes, 196) * 100;
    public static float SuspensionTravelMetersFR(this byte[] bytes) => GetSingle(bytes, 200) * 100;
    public static float SuspensionTravelMetersRL(this byte[] bytes) => GetSingle(bytes, 204) * 100;
    public static float SuspensionTravelMetersRR(this byte[] bytes) => GetSingle(bytes, 208) * 100;
    ...
    public static float Fuel(this byte[] bytes) => GetSingle(bytes, 276) * 100;
